...
self.addEventListener('fetch', event => { if (event.request.method === 'GET') { event.respondWith(onFetch(event)); } });

const cacheNamePrefix = 'virgen-tortuga-v';
